    ...
    <>
      ...
      <section className="container-page py-10">
        <div className="trust-hero mb-6 max-w-4xl">
          <p className="section-kicker text-red-200">Reader Notice</p>
          <h1 className="mt-2 text-4xl font-extrabold">Disclaimer</h1>
          <p className="mt-3 text-sm leading-6 text-gray-300">Important limits around news, opinion, external links and public information.</p>
        </div>
